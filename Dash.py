...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                options = [
                                    ...
                                    {'label': filtered['Launch Site'].iloc[0], 'value': filtered['Launch Site'].iloc[0]},
                                    {'label': filtered['Launch Site'].iloc[1], 'value': filtered['Launch Site'].iloc[1]},
                                    {'label': filtered['Launch Site'].iloc[2], 'value': filtered['Launch Site'].iloc[2]},
                                    {'label': filtered['Launch Site'].iloc[3], 'value': filtered['Launch Site'].iloc[3]},
                                ],
                                value = 'ALL',
